...
const page = (props: Props) => {
  ...
  return (
    <>
        {active === "See Profile" ? (
            <div className="overflow-y-scroll bg-gradient-agent h-screen">
                <GlobalContainer className='flex flex-col gap-5 pb-20'>
                    <TopBackBar handleClick={() => setActive('')} text='My Profile' />
                    <div className="rounded-full p-3 bg-superlightgreen text-majorgreen flex gap-1 items-center mx-auto">Edit Profile <Settings2 /> </div>
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col gap-1">
                            ...
                            <p className="text-majorgray text-sm">padreakpor25@yahoo.com</p>
                        </div>
                    </div>
                    <p className="text-center text-xl font-light">Total Earnings:</p>
                    <h2 className='md:text-5xl font-bold text-majorgreen text-4xl text-center'><sup className='text-xl font-light'>NGN</sup> 2,542,522.34</h2>
                    <div className="flex flex-col">
                        <div className="flex justify-between">
                            <p className="text-majorgray">Order Success</p>
                            <p className="font-bold text-majorgray">85%</p>
                        </div>
                        <div className="w-full h-2 rounded-full bg-superlightgreen overflow-hidden">
                            <div className="h-full w-[30%] bg-majorgreen"></div>
                        </div>
                    </div>
            ...
            <div className='overflow-y-scroll h-screen'>
                <GlobalContainer className='bg-gradient-agent flex flex-col gap-5 pb-10'>
                    {chart ? (
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-5 h-screen w-full overflow-y-scroll">
                                ...
                                <div className="rounded-r-full rounded-tl-full bg-majorgreen p-3 flex flex-col gap-1 max-w-[80%] w-fit text-white ms-auto self-start">
                            ...
                            <div className="md:w-1/2 w-full fixed left-1/2 -translate-x-1/2 md:p-5 p-3 bg-white gap-5 bottom-0 flex items-center">
                                <Plus strokeWidth={1} className="text-majorgreen" />
                                <label htmlFor='text' className="flex justify-between items-center w-full bg-superlightgreen rounded-full py-1 ps-2 pe-1">
                                    <input type="text" className='w-full outline-none' />
                                    <div className="w-10 flex-shrink-0 h-10 rounded-full text-white bg-majorgreen flex justify-center items-center">
                                        <Send strokeWidth={1} />
                                    </div>
                                </label>
                            </div>
                        ...
                        <>
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h1 className="text-2xl">2k<sub>+</sub> <span className='text-majorgreen'>Feeds</span></h1>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div onClick={() => setStatisticActive(true)} className={`w-10 h-10 rounded-full bg-superlightgreen flex justify-center items-center`}>
                                        <TrendingUp />
                                    </div>
                                    <MonthComponent text='View Code' />
                                </div>
                            </div>
                            {statisticActive ? (
                                <div className='flex flex-col gap-5 pb-50'>
                                    ...
                                    {backLineActive === "MY ANALYTICS" ? (
                                        <>
                                            {statisticArrayActive === "CHARTS" ? (
                                                ...
                                                <div className="flex flex-col gap-5">
                                                    <div className='flex flex-col py-5 border-y border-lightgray gap-10'>
                                                        <div className="flex flex-col gap-3">
                                                            ...
                                                            <div className="w-full rounded-full h-1 bg-lightgreen">
                                                ...
                                                <div className="flex flex-col gap-5">
                                                    <div className="p-5 rounded-xl bg-superlightgreen flex flex-col gap-3">
                                                        <p className="md:text-5xl text-3xl">You ranked <span className='text-lemongreen'>1398th!</span></p>
                                                        <div className="flex justify-between gap-3 items-center">
                                                            <div className="flex items-center gap-3">
                                                                ...
                                                                <div className="flex flex-col gap-2">
                                                                    ...
                                                                    <div className="rounded-full bg-majorgreen text-sm flex justify-center items-center">Sales Agent</div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div className="flex flex-col gap-5">
                                                        ...
                                                        <div className="flex justify-between">
                                                            ...
                                                            <div className="flex flex-col gap-1 items-end">
                                                                <p>TOP 60%</p>
                                                                <p className="text-superlightgreen">+302</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="flex flex-col">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="w-10 h-10 flex justify-center items-center bg-majorgreen text-majororange rounded-full">
                                                    <Star size={20} />
                                                </div>
                                            </div>
                                            <div className="flex items-center justify-between py-3 border-b border-lightgray">
                                                ...
                                                <div className="flex flex-col gap-1 items-end">
                                                    ...
                                                    <p className="text-sm text-majorgreen">+12</p>
                                                </div>
                                            </div>
                                        </div>
                                    )}
                                    <div className="flex flex-col gap-1">
                                        <div className="flex gap-1">
                                            <div className="flex flex-col gap-1 flex-grow">
                                                ...
                                                <button className="p-5 rounded-xl text-xl bg-lightgreen w-full flex">N14,032.56</button>
                                            </div>
                                            <div className="flex flex-col gap-1 items-center">
                                                <p className="text-sm text-lightgray">Increase</p>
                                                <button className="p-5 rounded-xl bg-majorgreen text-white">+ 20%</button>
                                            </div>
                                        </div>
                                        <div className="flex flex-col gap-1">
                                            <p className="text-sm text-lightgray">Inventory Total</p>
                                            <button className="py-1 px-1 rounded-xl text-xl bg-superlightgreen w-full flex items-center justify-between"><span  className='ps-3'>N14,032.56</span> <div className="w-10 h-10 rounded-lg flex justify-center items-center text-white bg-lightgreen"><ArrowRight /></div></button>
                                        </div>
                                    </div>
                                    <div className="md:w-1/2 w-full fixed left-1/2 -translate-x-1/2 md:p-5 p-3 bg-white flex flex-col gap-5 bottom-0">
                                        ...
                                        <button onClick={() => setChart(true)} className='bg-majorgreen p-3 rounded-xl text-white'>CONTACT SALES REP</button>
                                    </div>
                                </div>
                            ) : (
                                <>
                                        ...
                                        <>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {locationActiveArray.map((location) => (
                                                    <ButtonSimulation key={location} text={location} />
                                                ))}
                                            </div>
                                        </>
                                    )}
                                    ...
                                    {feedsFilterActive === "topic" && (
                                        <>
                                            <FlexTextNumber text='Top ' textNum={9} />
                                            <div className="flex flex-wrap gap-2">
                                    ...
                                    <div className="bg-superlightgreen md:p-5 p-3 rounded-2xl flex flex-col gap-3">
                                        <FlexComponent>
                                            <div className="flex flex-col">
                                                <p className='text-verydark'>#Onboarding</p>
                                                <p className="font-bold">Tope Alabi</p>
                                            </div>
                                            <div className="flex items-center gap-1">
                                                <div className="py-1 px-2 rounded-full bg-majorgreen text-sm">Sales Agent</div>
                                                <ChevronDown strokeWidth={1} />
                                            </div>
                                        </FlexComponent>
                                    ...
                                    <div className="md:w-1/2 w-full fixed left-1/2 -translate-x-1/2 md:p-5 p-3 bg-white flex flex-col gap-5 bottom-0">
                                        <label htmlFor='text' className="flex items-center gap-3 w-full">
                                            <Plus strokeWidth={1} className='text-majorgreen' size={30} />
                                            <input id='text' type="text" placeholder='Type a message...' className='w-full outline-none' />
                                        </label>
                                        <button className='bg-majorgreen p-3 rounded-xl text-white'>SEND POST</button>
                                    </div>
                                </>
                            )}
                        </>
            ...
            <div className="overflow-y-scroll h-screen">
                <GlobalContainer className='flex bg-gradient-agent flex-col gap-5 pb-20'>
                    <TopBackBar handleClick={() => setActive('')} text='My Profile' />
                    <ActiveTabStraight activeTabArray={["PAY IN", "WITHDRAWAL"]} activeTab={activeTab} setActiveTab={setactiveTab} />
                    {activeTab === "PAY IN" ? (
                        <>
                            <div className="flex flex-col gap-3 p-3 bg-majorgreen rounded-xl">
                                <div className="flex items-center justify-between">
                                    <p className="text-superlightgreen">Balance</p>
                                    <div className="rounded-full flex items-center gap-1 px-2 py-1 bg-superlightgreen">
                                        <p>EDIT ACCOUNT</p>
                                        <ChevronRight strokeWidth={1} />
                                    </div>
                                </div>
                                <p className="md:text-5xl text-superlightgreen text-3xl font-bold">N2,542,522.34</p>
                                <div className="flex items-center gap-3 text-superlightgreen">
                                    <TrendingUp strokeWidth={1} />
                                    <p>No recent addition</p>
                                </div>
                            </div>
                            <FilterTab subFilterTabArray={["A-Z", "DATE", "PRICING", "TRANSACTION"]} subFilterTab={subFilterTab} setSubFilterTab={setSubFilterTab} />
                            <div className="flex flex-col gap-3 bg-superlightgreen p-3 rounded-xl">
                                <p>Wallet Info</p>
                                <div className="flex items-center gap-2 relative">
                                    <div className="rounded-full p-1 text-white bg-lemongreen">
                                        <RefreshCcw strokeWidth={1} size={30} />
                            ...
                            <div className="p-4 rounded-xl bg-superlightgreen flex flex-col w-full">
                                <div className="flex justify-between items-center">
                                    <div className="flex items-center gap-2">
                                        <Image src={profile} width={1000} height={1000} alt='profile' className='w-10 h-10 rounded-full' />
                                        <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="rounded-full font-extrabold bg-superlightgreen py-1 px-2">3,000.00</div>
                                        <ChevronDown />
                                    </div>
                                </div>
                            </div>
                        ...
                        <>
                            <div className="flex flex-col gap-3 p-3 bg-majorgreen rounded-xl">
                                <div className="flex items-center justify-between">
                                    <p className="text-superlightgreen">Balance</p>
                                    <div className="rounded-full flex items-center gap-1 px-2 py-1 bg-lemongreen">
                                        <p>EDIT ACCOUNT</p>
                                        <ChevronRight strokeWidth={1} />
                                    </div>
                                </div>
                                <p className="md:text-5xl text-superlightgreen text-3xl font-bold">N0.00</p>
                                <div className="flex items-center gap-3 text-superlightgreen">
                                    <TrendingUp strokeWidth={1} />
                                    <p>No recent addition</p>
                                </div>
            ...
            <div className="overflow-y-scroll h-screen w-full bg-white">
                <GlobalContainer className='flex flex-col gap-5 bg-gradient-agent h-full'>
                    <div className="flex items-center justify-between">
                        <ChevronLeft strokeWidth={1} onClick={() => setActive("")} />
                    ...
                    <NotificationTab activeTabArray={notificationActiveTabArray} activeTab={unread} setActiveTab={setUnread} />
                    <div className="flex flex-col gap-3 border-b py-3 border-lightgray">
                        <div onClick={() => setDrop(!drop)} className="flex justify-between items-center gap-5">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="py-1 px-2 flex justify-center items-center bg-superlightgreen flex-shrink-0 rounded">
                                    3 mins
                                </div>
                                <ChevronDown strokeWidth={1} />
                            </div>
                        ...
                        <div ref={notificationRef} className="flex flex-col w-full gap-3 overflow-y-hidden transition-height duration-200 ease-in-out" style={{
                            ...
                            <div className="md:p-4 flex-shrink-0 p-2 rounded-2xl bg-superlightgreen flex flex-col gap-3">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="bg-lemongreen shadow p-2 rounded-full md:text-md text-sm">
                                        INCOMING
                                    </div>
                                    <ChevronDown strokeWidth={1} />
                                </div>
            ...
            <GlobalContainer className='flex flex-col justify-between h-screen bg-white gap-5 overflow-y-auto pb-40'>
                ...
                <div className="flex justify-center items-center relative w-40 mx-auto">
                    ...
                    />
                    <div className="absolute -right-3 w-7 h-7 bg-majorgreen rounded-full flex justify-center items-center text-white">
                        <Plus strokeWidth={1} />
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-2 w-full">
                    {settingsArray.map((setting, index) => (
                        <div onClick={() => {setActive(setting), setAddProduct(true)}} key={index} className={`flex justify-between items-center rounded-full p-3 ${active === setting ? "bg-superlightgreen" : 'bg-transparent'}`}>

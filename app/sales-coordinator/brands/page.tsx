                                        ...
                                        <>
                                            ...
                                            <div className="rounded-xl bg-lightgreen p-5 flex flex-col gap-3">
                                                <div className="p-5 rounded-xl bg-white flex justify-center items-center relative">
                                                    ...
                                                    <ArrowUp strokeWidth={1.5} size={40} className='absolute text-lightorange' />
                                                </div>
                                                <FlexComponent>
                        ...
                        <GlobalContainer className="flex flex-col justify-between gap-5 bg-gradient-agent">
                            ...
                            <div className="rounded-xl flex flex-col gap-4 mt-5">
                                ...
                                <div className="flex md:gap-3 gap-2 items-center justify-end">
                                    <div className="md:w-3 md:h-3 w-2 h-2 rounded-full bg-lightorange"></div>
                                ...
                                <FlexComponent>
                                    <div className="flex gap-2">
                                        <div className="rounded-xl bg-lightorange text-white p-3">
                                            <Settings2 />
                                        </div>
                            ...
                            <div className="flex flex-col gap-3">
                                <FlexComponent>
                                    ...
                                    <div className="w-7 h-7 rounded-full flex justify-center items-center bg-lightorange text-white">
                                        <Check strokeWidth={1} />
                                    </div>
                                </FlexComponent>
            ...
            <>
                {addProduct ? (
                        ...
                        </FlexComponent>
                        {
                            activeNumber === 1 ? (
                                <>
                                    ...
                                    <FlexTextNumber orange={true} text='Sector' desc='Select up to 2 options' textNum={11} />
                                    <div className="flex flex-wrap gap-3">
                                        {activeSector.map((sector, index) => (
                                            <ButtonSimulation key={index} text={sector} />
                                        ))}
                                ...
                                <>
                                    ...
                                    <div className="rounded-xl bg-lightgreen p-5 flex flex-col gap-3">
                                        <div className="p-5 rounded-xl bg-white flex justify-center items-center relative">
                                            <ProgressBar orange strokeWidth={5} progress={80} />
                                            <ArrowUp strokeWidth={1.5} size={40} className='absolute text-lightorange' />
                                        </div>
                                        <FlexComponent>
                                            <p className="font-bold md:text-xl">YOUR LOGO</p>
                    ...
                    <div className='overflow-y-auto h-screen'>
                        <GlobalContainer className="flex flex-col gap-5 bg-gradient-coordinator">
                            <FlexComponent>
                                <h1 className='text-3xl font-light'>My <span className='text-superlightgreen font-bold'>Brands</span></h1>
                                ...
                                <>
                                    <div className="p-3 rounded-xl bg-gradient-trans flex flex-col gap-3">
                                        ...
                                        <div className="flex items-center gap-2 relative">
                                            ...
                                            <div onClick={() => setShowTarget(!showTarget)} className="flex items-center gap-2 text-lightgray cursor-pointer">
                                    ...
                                    <div className="flex items-center gap-5 overflow-x-auto">
                                        {filterTabArray.map((tab, index) =>  (
                                            <div onClick={() => setFilterTab(tab.toLowerCase())} key={index} className={`py-2 flex-shrink-0 ${filterTab === tab.toLowerCase() ? "border-b-2 border-lightorange text-lightorange" : 'text-lightgray'}`}>{tab}</div>
                                        ))}
                                    </div>
                                    <FilterTab orange subFilterTabArray={subFilterTabArray} setSubFilterTab={setSubFilterTab} subFilterTab={subFilterTab} />
                                    <OnboardNew orange  setAddProduct={setAddProduct} descNum={104} show addType='ONBOARDING NEW' />
                                    <FlexComponent>
                                    ...
                                    <div className='bg-superlightgreen p-3 rounded-xl mb-50'>
                                        ...
                                        <div className="bg-white p-3 rounded-xl flex flex-col gap-4 mt-5">
                                            ...
                                            <div className={`${permission ? "flex" : "hidden"} flex-col items-center gap-3 p-3 md:w-[40%] w-80 left-1/2 -translate-x-1/2 rounded-2xl border border-majorgray fixed bg-white top-1/2 -translate-y-1/2 z-2`}>
                                                ...
                                                <div className="flex flex-col gap-2 items-center">
                                                    <div className="w-7 h-7 rounded-full flex justify-center items-center bg-lemongreen text-lightorange">
                                                        <Check strokeWidth={1} />
                                                    </div>
                                                    <p className="text-majorgray md:text-md:text-sm text-center">Vendor Reviewing...</p>
                                                </div>
